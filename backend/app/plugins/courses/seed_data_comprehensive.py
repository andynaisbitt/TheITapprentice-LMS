...
def create_it_support_course(db: Session, instructor_id: int) -> Course:
    ...
    create_section(db, ModuleSectionCreate(
        ...
        is_required=True,
        content_blocks=[
            {"id": "b5", "type": "heading", "content": {"text": "Understanding Support Lines", "level": 2}},
            {"id": "b6", "type": "text", "content": {"text": "IT support is organised into 'lines' of support, each handling different levels of complexity. The exact structure varies by organisation size, but understanding the common model helps you know when to solve issues yourself and when to escalate.", "markdown": True}},
            {"id": "b7", "type": "text", "content": {"text": "### Common Support Structure\n\n**1st Line Support (Service Desk/Help Desk)**\n- First point of contact for all users\n- Password resets, account unlocks, basic troubleshooting\n- Logging tickets and initial triage\n- Following scripts and knowledge base articles\n- Aims to resolve 60-70% of issues at first contact\n\n**2nd Line Support (Desktop/Technical Support)**\n- Escalation point for complex desktop issues\n- Software installations and configurations\n- Hardware repairs and replacements\n- Remote desktop support\n- Deskside visits when needed\n\n**3rd Line Support (Infrastructure/Specialists)**\n- Server and network administration\n- System-level problems\n- Liaising with vendors\n- Project work and implementations\n\n**Field Support/On-site Engineers**\n- Physical site visits for hardware issues\n- May cover multiple locations\n- Common in larger or distributed organisations\n\n**External/Vendor Support**\n- Manufacturer support for specific products\n- Managed service providers (MSPs)\n- Specialist contractors", "markdown": True}},
            {"id": "b8", "type": "callout", "content": {"type": "info", "title": "Small Team Reality", "message": "In smaller organisations, you might be the entire IT department! Roles often overlap - you could be doing 1st line tickets in the morning and server maintenance in the afternoon. An IT Manager might oversee everything with one or two technicians."}}
        ]
    ), mod1.id)
    ...
    create_section(db, ModuleSectionCreate(
        ...
        content_blocks=[
            ...
            {"id": "b10", "type": "quiz", "content": {
                "questions": [
                    {"id": "q1", "question": "Which line of IT support typically handles password resets?", "type": "multiple_choice", "options": ["1st Line Support", "2nd Line Support", "3rd Line Support", "External Vendor"], "correct_answer": "1st Line Support", "explanation": "1st Line (Service Desk) handles common, straightforward issues like password resets, allowing higher lines to focus on complex problems."},
                    {"id": "q2", "question": "True or False: IT support technicians should document their solutions.", "type": "true_false", "options": ["True", "False"], "correct_answer": "True", "explanation": "Documentation is essential! It helps other technicians solve similar issues and builds your organisation's knowledge base."},
                    {"id": "q3", "question": "What percentage of issues does 1st Line Support typically aim to resolve?", "type": "multiple_choice", "options": ["20-30%", "40-50%", "60-70%", "90-100%"], "correct_answer": "60-70%", "explanation": "A well-functioning 1st Line resolves the majority of issues at first contact, filtering only complex problems to higher lines."}
                ],
                "passing_score": 70
            }}
        ]
        ...
        content_blocks=[
            ...
            {"id": "b69", "type": "quiz", "content": {
                "questions": [
                    ...
                    {"id": "fq3", "question": "True or False: You should always restart the Print Spooler service before checking if the printer is powered on.", "type": "true_false", "options": ["True", "False"], "correct_answer": "False", "explanation": "Always check the basics first - power, connections, and obvious issues before technical solutions."},
