...
export const CategoryShowcase: React.FC = () => {
  ...
  const loadCategories = async () => {
    try {
      ...
      // Get top 6 categories (show all, including empty ones)
  ...
  return (
    <>
        ...
        {categories.map((category) => (
          <motion.div key={category.id} variants={cardVariants}>
            <Link
              ...
              className="group block p-6 bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-xl transition-all hover:-translate-y-2 transform"
              style={{
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                {/* Name */}
                <h3
                  className="font-semibold text-sm mb-1 group-hover:scale-105 transition-transform"
      ...
      <div className="mt-8 text-center">
        <Link
          to="/blog"
          className="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-600 text-white rounded-lg transition-colors font-medium shadow-md hover:shadow-lg"
        >
          View All Categories
