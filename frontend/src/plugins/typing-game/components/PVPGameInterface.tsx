...
export const PVPGameInterface: React.FC<PVPGameInterfaceProps> = ({
  ...
  const renderText = () => {
    return roundText.split('').map((char, index) => {
      ...
      if (index < userInput.length) {
        ...
        className = 'text-gray-900 dark:text-white bg-blue-100 dark:bg-blue-900/50 border-l-2 border-blue-500';
      }
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-6">
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          {/* Text Display */}
          <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-900 rounded-lg font-mono text-lg leading-relaxed select-none">
            {renderText()}
          </div>
