  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/30 dark:from-slate-900 dark:via-slate-900 dark:to-slate-900">
      <div className="max-w-7xl mx-auto px-4 py-6 sm:py-12">
        ...
        >
          {/* Icon */}
          <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 text-white mb-4 sm:mb-6 shadow-lg shadow-blue-500/25">
            <GraduationCap className="w-6 h-6 sm:w-8 sm:h-8" />
          </div>

          <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold text-slate-900 dark:text-white mb-2 sm:mb-4">
            Explore Our{' '}
          ...
          <p className="text-sm sm:text-lg text-slate-600 dark:text-slate-400 max-w-3xl mx-auto">
            Master IT skills with expert-designed courses. Learn at your own pace with hands-on projects.
          </p>

          {/* Stats */}
          <div className="mt-4 sm:mt-8 flex items-center justify-center gap-4 sm:gap-8 text-slate-500 dark:text-slate-400">
            <div className="flex items-center gap-1.5 sm:gap-2">
              <BookOpen size={16} className="text-blue-500 dark:text-blue-400 sm:w-5 sm:h-5" />
              <span className="font-medium text-xs sm:text-base">{totalCourses} Courses</span>
            </div>
            <div className="flex items-center gap-1.5 sm:gap-2">
              <Users size={16} className="text-indigo-500 dark:text-purple-400 sm:w-5 sm:h-5" />
              <span className="font-medium text-xs sm:text-base">Expert Instructors</span>
            </div>
            <div className="flex items-center gap-1.5 sm:gap-2">
              <Award size={16} className="text-emerald-500 dark:text-green-400 sm:w-5 sm:h-5" />
              <span className="font-medium text-xs sm:text-base">Certificates</span>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-white/80 dark:bg-slate-800/60 backdrop-blur-sm rounded-2xl p-4 sm:p-6 mb-6 sm:mb-8 border border-slate-200 dark:border-slate-700/50 shadow-sm"
        >
          <div className="flex flex-col md:flex-row gap-4 items-center">
            ...
            {/* Level Filter */}
            <div className="flex gap-2 overflow-x-auto sm:flex-wrap sm:justify-center pb-1 sm:pb-0 no-scrollbar">
              <button
          ...
          >
            {courses
              ...
              return (
                ...
                >
                  {/* Course Image */}
                  <div className="relative h-36 sm:h-48 bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-slate-700 dark:to-slate-700 overflow-hidden">
                    {course.image ? (
                      <img
                        src={course.image}
                        alt={course.title}
